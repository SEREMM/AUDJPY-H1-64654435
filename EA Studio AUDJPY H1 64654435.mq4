...
input int Take_Profit = 146; // Take Profit (pips)
static input string Ind1 = "------------";// ----- Directional Indicators -----
input int Ind1Param0 = 30; // Period
static input string Ind2 = "------------";// ----- Volumes -----
input int Ind2Param0 = 638160; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 64654435; // Magic Number
...
void ManageClose()
  {
   double ind2val1 = (double) iVolume(NULL,0,1);
   double ind2val2 = (double) iVolume(NULL,0,2);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; AUDJPY; H1 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":35,"takeProfit":146,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"On Balance Volume","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Directional Indicators","listIndexes":[0,0,0,0,0],"numValues":[30,0,0,0,0,0]}],"closeFilters":[{"name":"Volumes","listIndexes":[4,0,0,0,0],"numValues":[638160,0,0,0,0,0]}]} */
